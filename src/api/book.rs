...
use crate::model::models::Bookstore;

async fn sample() -> Result<(), sqlx::Error> {
    ...
    let pool = PgPoolOptions::new()
        .max_connections(5)
        // .connect(&databaseurl)
        // .connect("postgres://USUARIO:SENHA@www.postgresql.dbaas.com.br:5432/database1")
    ...
    let results = rows
        .iter()
        .map(|row| format!(r"{} - {}\n", row.get::<i32, _>("id"), row.get::<String, _>("nome") ))  
        .collect::<Vec<String>>()
        .join(", ");
